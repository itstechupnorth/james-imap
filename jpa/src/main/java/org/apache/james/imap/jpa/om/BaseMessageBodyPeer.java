 ...
 * 
 */
abstract class BaseMessageBodyPeer extends BasePeer {
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(MessageBodyMapBuilder.CLASS_NAME)
     *             instead
     */
    ...
    public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
        return BaseMessageBodyPeer.doInsert(criteria, (Connection) null);
    }
     ...
     *             wrapped into a TorqueException.
     */
    public static MessageBody row2Object(Record row, int offset, Class cls)
            throws TorqueException {
        try {
     ...
     *             wrapped into a TorqueException.
     */
    public static void populateObject(Record row, int offset, MessageBody obj)
            throws TorqueException {
        try {
    ...
    public static List doSelectVillageRecords(Criteria criteria)
            throws TorqueException {
        return BaseMessageBodyPeer.doSelectVillageRecords(criteria,
                (Connection) null);
    }
    ...
    public static List populateObjects(List records) throws TorqueException {
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            results.add(MessageBodyPeer.row2Object(row, 1, MessageBodyPeer
                    .getOMClass()));
        }
        return results;
    }
    ...
    public static void doUpdate(Criteria criteria) throws TorqueException {
        BaseMessageBodyPeer.doUpdate(criteria, (Connection) null);
    }
    ...
    public static void doDelete(Criteria criteria) throws TorqueException {
        MessageBodyPeer.doDelete(criteria, (Connection) null);
    }
    ...
    /**
     * Method to do inserts. This method is to be used during a transaction,
     * otherwise use the doInsert(MessageBody) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     ...
     * otherwise use the doUpdate(MessageBody) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     *            the data object to update in the database.
     ...
     * otherwise use the doDelete(MessageBody) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     *            the data object to delete in the database.
    ...
    public static void doDelete(ObjectKey pk) throws TorqueException {
        BaseMessageBodyPeer.doDelete(pk, (Connection) null);
    }
     ...
     *            long
     */
    public static MessageBody retrieveByPK(long mailboxId, long uid)
            throws TorqueException {
        Connection db = null;
        MessageBody retVal = null;
        try {
    ...
    protected static List doSelectJoinMessageRow(Criteria criteria,
        ...
        criteria.addJoin(MessageBodyPeer.MAILBOX_ID, MessageRowPeer.MAILBOX_ID);
        criteria.addJoin(MessageBodyPeer.UID, MessageRowPeer.UID);
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            MessageBody obj1 = (MessageBody) MessageBodyPeer.row2Object(row, 1,
                    omClass);
