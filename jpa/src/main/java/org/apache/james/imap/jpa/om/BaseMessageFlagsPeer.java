 ...
 * 
 */
abstract class BaseMessageFlagsPeer extends BasePeer {
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(MessageFlagsMapBuilder.CLASS_NAME)
     *             instead
     */
    ...
    protected static final String CLASSNAME_DEFAULT = MessageFlags.class.getName();
    ...
    public static ObjectKey doInsert(Criteria criteria) throws TorqueException {
        return BaseMessageFlagsPeer.doInsert(criteria, (Connection) null);
    }
     ...
     *             wrapped into a TorqueException.
     */
    public static MessageFlags row2Object(Record row, int offset, Class cls)
            throws TorqueException {
        try {
     ...
     *             wrapped into a TorqueException.
     */
    public static void populateObject(Record row, int offset, MessageFlags obj)
            throws TorqueException {
        try {
    ...
    public static List doSelectVillageRecords(Criteria criteria)
            throws TorqueException {
        return BaseMessageFlagsPeer.doSelectVillageRecords(criteria,
                (Connection) null);
    }
    ...
    public static List populateObjects(List records) throws TorqueException {
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            results.add(MessageFlagsPeer.row2Object(row, 1, MessageFlagsPeer
                    .getOMClass()));
        }
        return results;
    }
    ...
    public static void doUpdate(Criteria criteria) throws TorqueException {
        BaseMessageFlagsPeer.doUpdate(criteria, (Connection) null);
    }
    ...
    public static void doDelete(Criteria criteria) throws TorqueException {
        MessageFlagsPeer.doDelete(criteria, (Connection) null);
    }
    ...
    /**
     * Method to do inserts. This method is to be used during a transaction,
     * otherwise use the doInsert(MessageFlags) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     ...
     * otherwise use the doUpdate(MessageFlags) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     *            the data object to update in the database.
     ...
     * otherwise use the doDelete(MessageFlags) method. It will take care of the
     * connection details internally.
     * 
     * @param obj
     *            the data object to delete in the database.
    ...
    public static void doDelete(ObjectKey pk) throws TorqueException {
        BaseMessageFlagsPeer.doDelete(pk, (Connection) null);
    }
     ...
     *            long
     */
    public static MessageFlags retrieveByPK(long mailboxId, long uid)
            throws TorqueException {
        Connection db = null;
        MessageFlags retVal = null;
        try {
    ...
    protected static List doSelectJoinMessageRow(Criteria criteria,
        ...
        criteria
                .addJoin(MessageFlagsPeer.MAILBOX_ID, MessageRowPeer.MAILBOX_ID);
        criteria.addJoin(MessageFlagsPeer.UID, MessageRowPeer.UID);
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            MessageFlags obj1 = (MessageFlags) MessageFlagsPeer.row2Object(row,
                    1, omClass);
