 ...
 */
abstract class BaseMessageFlags extends BaseObject {
    /** Serial version */
     ...
     * message_flags and message. If for some reason this is impossible, this
     * method should be overridden in <code>MessageFlags</code>.
     */
     ...
     *            the object to fill.
     */
    protected MessageFlags copyInto(MessageFlags copyObj)
            throws TorqueException {
     ...
     */
    protected MessageFlags copyInto(MessageFlags copyObj, boolean deepcopy)
            throws TorqueException {
    ...
    public String toString() {
        ...
        str.append("Answered = ").append(getAnswered()).append("\n");
        str.append("Deleted = ").append(getDeleted()).append("\n");
        str.append("Draft = ").append(getDraft()).append("\n");
        str.append("Flagged = ").append(getFlagged()).append("\n");
        str.append("Recent = ").append(getRecent()).append("\n");
        str.append("Seen = ").append(getSeen()).append("\n");
        return (str.toString());
    }
}
