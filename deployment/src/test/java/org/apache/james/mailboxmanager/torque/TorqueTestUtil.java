...
public class TorqueTestUtil extends TestUtil {
    ...
    public static void clearTables() throws TorqueException {
        // MessageBodyPeer.doDelete(new
        // Criteria().and(MessageBodyPeer.MAILBOX_ID,
        // new Integer(-1), Criteria.GREATER_THAN));
        // MessageHeaderPeer.doDelete(new
        // Criteria().and(MessageHeaderPeer.MAILBOX_ID,
        // new Integer(-1), Criteria.GREATER_THAN));
        // MessageFlagsPeer.doDelete(new
        // Criteria().and(MessageFlagsPeer.MAILBOX_ID,
        // new Integer(-1), Criteria.GREATER_THAN));
